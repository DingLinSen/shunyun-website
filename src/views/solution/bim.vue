<template>
  <div class="park">
    ...
    <!-- 内容-->
    <div class="container">
      <div class="title">智慧加油站</div>
      <div class="detail">方案概述</div>
      <div class="solutionContent">
        <div class="solutionLeft">
          <div class="text">
            <p class="ti">
              针对加油站安全事故频发的问题，采用视频智能分析技术，对加油区和卸油区人员的打电话、抽烟等违规行为，明火、烟雾等异常状况进行智能识别、告警和记录，智慧加油站可以实现区域内事件自动告警，告警数据为监管部门精度实施提供决策依据，助力加油站安全稳定运行。
            </p>
            <img src="@/assets/images/solution/图片12.png" alt="" />
            ...
            <img src="@/assets/images/solution/图片13.png" alt="" />
          </div>
        </div>
